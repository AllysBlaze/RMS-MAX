...
namespace RMSmax.Models
{
    public class FakeSubjectRepository:ISubjectRepository
    {
        ...
        {
            new Subject{Id=0,Degree="Stopień", Name="Nazwa", File="Plik" ,Semester="Semestr", Course="Kierunek"},
            new Subject{Id=1,Degree="Stopień", Name="Nazwa", File="Plik" ,Semester="Semestr",Course="Kierunek"},
            new Subject{Id=2,Degree="Stopień", Name="Nazwa", File="Plik" ,Semester="Semestr",Course="Kierunek"},
            new Subject{Id=3,Degree="Stopień", Name="Nazwa", File="Plik" ,Semester="Semestr",Course="Kierunek"},
            new Subject{Id=4,Degree="Stopień", Name="Nazwa", File="Plik" ,Semester="Semestr",Course="Kierunek"},
            new Subject{Id=5,Degree="Stopień", Name="Nazwa", File="Plik" ,Semester="Semestr",Course="Kierunek"},
